...
if [ ! -d Std ]; then
    ...
    wget http://www.hlevkin.com/TestImages/goldhill.bmp
    wget http://www.hlevkin.com/TestImages/monarch.bmp
    ...
    wget -O barbara.grey.png http://decsai.ugr.es/~javier/denoise/barbara.png
    wget -O lena.grey.png http://decsai.ugr.es/~javier/denoise/lena.png
    convert bridge.grey -type GrayScaleMatte tmp.png
    mv tmp.png bridge.grey
    convert man.grey -type GrayScaleMatte tmp.png
    mv tmp.png  man.grey
    cd ..
fi
