function [D, D_bar, Y, optinf] = samecoeff_multilearn(D0, S,S_bar, lambda, opt)
...
%       S           Input images of higher resolution
%       S_bar       Input images of lower resolution
%       lambda      Regularization parameter
%       opt         Options/algorithm parameters structure (see below)
%
% Output:
%       D           High Res dictionary
%       Dl          Low Res dictionary
