...
for i = 6:length(num_dict)
    for j = 1:length(ind_all)
        ...
        fname = ([sporco_path,'/Graph/CacheData/DictStandard1/Dictcomp1',...
...
for i = 1:length(num_dict)
    for j = 1:length(ind_all)
        ...
        maxit = 300;
        [D1,D2,Aind1,Aind2] = exp_dict_1(D_init,lambda,mu,imind,maxit);
        fname = ([sporco_path,'/Graph/CacheData/DictStandard1/Dictcomp2',...
            num2str(i),num2str(j),'.mat']);
        save(fname,'D1','D2','Aind1','Aind2','lambda','mu','imind','n');
    end
end
...
for i = 1:length(num_dict)
    for j = 1:length(ind_all)
        ...
        maxit = 300;
        [D1,D2,Aind1,Aind2] = exp_dict_1(D_init,lambda,mu,imind,maxit);
        fname = ([sporco_path,'/Graph/CacheData/DictStandard1/Dictcomp3',...
            num2str(i),num2str(j),'.mat']);
        save(fname,'D1','D2','Aind1','Aind2','lambda','mu','imind','n');
    end
end
