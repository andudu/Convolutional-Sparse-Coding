%experiment 1 for dictionary learning
function [D1,D2,Aind1, Aind2] = exp_dict_1(D0,lambda,mu, imind,maxit)
...
ii = 1;
for i = imind
    load([sporco_path,'/Graph/CacheData/Standard/Eig/Cosineeig',num2str(i),'.mat']);
    L{ii,1}.phi = phi; 
